        ...
        return (
            <header className="main_content__header">
                <div className="main_content__group">
                    <Link to = "/dashboard/projects" className = "main_content__group__item">All Projects ({this.state.amount})</Link>
                    <Link to = "/dashboard/projects/workflow" className="main_content__group__item">Workflow</Link>
                </div>
                <div className="main_content__group">
