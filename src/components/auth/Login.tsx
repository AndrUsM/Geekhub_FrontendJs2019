...
import {Login as reduxLoginAction} from '../redux/auth/actions';
...
class Login extends Component<{}, LoginStateItem> {
    ...
    handleSubmit(event: React.FormEvent){
        ...
        new Fetcher().post(`api/users/login`, "none", {
            ...
            if(response.status > 199 && response.status < 400){
                ...
                reduxLoginAction(response.data._id).setIdToLocalStorage();
                this.redirect();
            }
        })
        .catch(error => {
